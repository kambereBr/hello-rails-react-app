...
**hello-rails-react-app** is an application that combines the Rails framework with React.js, a popular JavaScript library for building user interfaces.
...
```sh
  cd project-folder
  git clone https://github.com/kambereBr/hello-rails-react-app.git
```
